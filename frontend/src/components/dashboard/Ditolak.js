...
export default class Ditolak extends Component {
  constructor(props) {
    super(props);
  ...
  getSurat() {
    ...
    Req.get(`/api/get_surat_ditolak/${user.id}/${user.user_type}/${current_page}/${limit}`, {
      headers : {
  ...
  render() {
    document.title = "Surat | Surat yang ditolak"
    ...
    return (
      <div className="container-fluid">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item text-muted"><i className="fa fa-times fa-lg"></i>&nbsp;Ditolak</li>
        </ol>
        <div className="card m-2">
          <div className="card-header">
            <div className="row">
              <div className="col-sm-8 mb-0 text-muted"><i className="fa fa-times fa-lg"></i> Ditolak</div>
          ...
          <div className="card-body">
            {
              ...
              <p className="text-center text-muted mb-0">{
                !query ? `Tidak ada surat yang ditolak` : `Surat yang dicari tidak ada. key : ${query}`
              }</p>
            }
          </div>
